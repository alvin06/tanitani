		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="logo span3">
					...
					<a class="brand" href="postlogin_homepage.php"><img src="img/logotani.png" alt="Logo"></a>
					...
					<div class="navbar navbar-inverse">
			    		<div class="navbar-inner">
			          		...
			          		<div class="nav-collapse collapse">
			            		<ul class="nav">
			              			<li><a href="post_produk.php">Jual-Beli</a></li>
									...
									<li class="dropdown">
			                			...
			                			<ul class="dropdown-menu">
			                  				...
			                  				<li><a href="post_detail.php">Keranjang</a></li>
	...
	<div id="page-title">
		...
		<div id="page-title-inner">
			...
			<div class="container">
				...
				<h2><i class="ico-user ico-white"></i>Profile Saya</h2>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
          ...
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              <div class="row">
                <div class="col-md-3 col-lg-3 " align="center"> <img alt="User Pic" src="img/logos/10.png" class="img-circle img-responsive"> </div>
                 ...
                 <form id="formku" action="#" method="post">
                  <table class="table table-condensed">
                    <tbody>
                      <tr>
                        <td>Fullname:</td>
                        <td><input name="fullname" type="text" class="form-control" placeholder="Ilham Sangat Bokep"></td>
                      </tr>
                       <tr>
                        <td>Username:</td>
                        <td><input name="username" type="text" class="form-control" placeholder="Ilham Bokep"></td>
                      </tr>
                      <tr>
                        <td>Aktif Sejak:</td>
                      ...
                      <tr>
                        <td>Email</td>
                        <td><input name="email" type="email" class="form-control" placeholder="info@support.com"></a></td>
                      </tr>
                        <td>Phone Number</td>
                        <td><input name="phonenumber" type="number" class="form-control" placeholder="123-4567-890(Landline)"><br>
                        </td>
