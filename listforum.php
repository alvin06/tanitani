	...
	<div id="page-title">
		...
		<div id="page-title-inner">
			...
			<div class="container">
				...
				<h2><i class="ico-user ico-white"></i>Forum</h2>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
          ...
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              <div class="row">
                  <a href="inputforum.php"><button class="btn" type="submit">Input Forum</button></a><br><br>
                      ...
                      $query = "SELECT * FROM article"; // Query untuk menampilkan semua data siswa
