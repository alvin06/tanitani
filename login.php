...
<html lang="en">
  <head>
    ...
    <title>Log In Tani-Tani.com</title>
...
<!-- role="form" -->
      <form class="form-signin" method="post" action="proseslogin.php">
        ...
        <h5 class="baru">Log In To User Tani-Tani.com</h5>
        ...
        <center><p>Sudahkah Anda Daftar? <a href="signup.html">Silahkan Daftar</a></p></center>
    </div> <!-- /container -->
